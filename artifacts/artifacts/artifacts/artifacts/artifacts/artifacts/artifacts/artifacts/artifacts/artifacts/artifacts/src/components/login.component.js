...
class Login extends Component {
    ...
    render() {
        return (React.createElement(ThemeProvider, { uiTheme: uiTheme }, React.createElement(Card, null, React.createElement(CardSection, null, React.createElement(Input, { label: "email", placeholder: "Insert email", value: this.props.email, onChangeText: this.onEmailChange.bind(this) })), React.createElement(CardSection, null, React.createElement(Input, { secure: true, label: "password", placeholder: "Insert password", value: this.props.password, onChangeText: this.onPasswordChange.bind(this) })), React.createElement(Container, { spring: true, loading: this.state.loading, error: this.state.error, message: this.state.message }, React.createElement(Text, null, " wtf ")), React.createElement(CardSection, null, this.renderButton()))));
    }
}
